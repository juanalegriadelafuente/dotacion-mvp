...
export default function HomePage() {
  ...
  <div className="brandSub">Herramienta gratuita para dimensionar dotación por tramos (cada 30 minutos).</div>
</div>
      ...
      <div style={{ marginTop: 18 }} className="grid2">
        <div className="card">
          <div className="cardPad">
            <h1 className="h1">Calculadora de Dotación por Tramos (30 min) — Chile</h1>
            <p className="p">
              Si tu operación <b>sube y baja por hora</b> (retail, alimentación, bodegas, clínicas…), aquí puedes cargar tu
              <b> necesidad operativa</b> como una grilla: <b>cuántas personas necesitas cada 30 minutos</b>. Luego te devolvemos{" "}
              <b>horas-persona</b>, <b>FTE</b> y <b>mix de contratos sugerido</b>.
            </p>
            ...
            <div style={{ marginTop: 10 }} className="small">
              Palabras clave: <b>calculadora de dotación</b>, <b>dimensionamiento de personal</b>, <b>dotación por tramos</b>.
            </div>
          </div>
        </div>
        ...
        <div className="card">
          <div className="cardPad">
            ...
            <div style={{ marginTop: 10 }} className="small">
              Tú cargas los tramos. La herramienta te devuelve <b>FTE</b> y <b>alternativas de mix</b>.
            </div>
          </div>
        </div>
      </div>
      ...
      <div id="como" style={{ marginTop: 14 }} className="grid2">
        ...
        <Card title="Qué cambió (y por qué es mejor)">
          <div>
            Antes era “semana simple”. Ahora es <b>necesidad operativa por tramos de 30 min</b>. Eso permite modelar picos (almuerzo,
            salida, cierre), días distintos (sábado/domingo) y operaciones que cruzan medianoche.
          </div>
        </Card>
        ...
        <Card title="Para quién es">
          Operaciones, RRHH, jefaturas de local y cualquiera que necesite responder rápido:{" "}
          <b>“Con esta demanda por hora… ¿cuántas personas contrato y con qué mix?”</b>
        </Card>
      </div>
